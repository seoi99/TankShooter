...
* fix certain arguments not being correctly escaped or causing batch syntax error ([500cf10](https://github.com/moxystudio/node-cross-spawn/commit/500cf10)), closes [#82](https://github.com/moxystudio/node-cross-spawn/issues/82) [#51](https://github.com/moxystudio/node-cross-spawn/issues/51)
* fix commands as posix relatixe paths not working correctly, e.g.: `./my-command` ([500cf10](https://github.com/moxystudio/node-cross-spawn/commit/500cf10))
* fix `options` argument being mutated ([500cf10](https://github.com/moxystudio/node-cross-spawn/commit/500cf10))
* fix commands resolution when PATH was actually Path ([500cf10](https://github.com/moxystudio/node-cross-spawn/commit/500cf10))


### Features

* improve compliance with node's ENOENT errors ([500cf10](https://github.com/moxystudio/node-cross-spawn/commit/500cf10))
* improve detection of node's shell option support ([500cf10](https://github.com/moxystudio/node-cross-spawn/commit/500cf10))
