...
class PlayerTank {
  constructor(ctx, tankImg, score, playerLife) {
    ...
    this.sound = new Sound("http://soundimage.org/wp-content/uploads/2016/04/Explosion1.mp3")
  }
  ...
  shoot() {
    this.bullet.push(new Bullet(this.ctx, this.rotation, this.x, this.y, this.score));
  }
  deletePlayer() {
    this.posY = 164;
    this.ctx.save();
